...
from .flyingchairdataset import FCDataset
...
class FCTrainDataModule(pl.LightningDataModule):
	...
	def train_dataloader(self):
		...
		train_split = FCDataset(self.data_dir, transform=self.train_transform,mode = 'train')
	...
	def val_dataloader(self):
		...
		val_split = FCDataset(self.data_dir, transform=self.train_transform,mode = 'test')
