...
class EndoTrainDataModule(pl.LightningDataModule):
	...
	def train_dataloader(self):
		...
		train_split = EndoDataset(self.data_dir, img_transform=self.train_transform[0],flow_transform=self.train_transform[1],mode = 'training')
	...
	def val_dataloader(self):
		...
		val_split = EndoDataset(self.data_dir, img_transform=self.train_transform[0],flow_transform=self.train_transform[1],mode = 'test')
