...
from dataset.flyingchair_module import FCTrainDataModule
from dataset.flyingchairdataset import FCDataset
...
def main():
    ...
    trainset = FCTrainDataModule(data_dir=args.train_data_dir,
